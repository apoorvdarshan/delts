...
App Store Connect submission details for Delts. Each field is in a code block for easy copy-paste.
...
## Promotional Text (170 chars max)
    ...
    Plan workouts, start the timer, log sets and RPE, and track weight and body fat progress with a focused iPhone gym app.

## Keywords (100 chars max)

    workout,gym,fitness,timer,sets,reps,RPE,weight,bodyfat,tracker,progress,health,training,planner
...
## Reviewer Notes
    ...
    6) Support contacts: apoorvdarshan@gmail.com and ad13dtu@gmail.com.
